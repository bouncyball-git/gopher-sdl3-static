...
// Scancode is the physical representation of a key on the keyboard.
...
const (
	...
	SCANCODE_RESERVED Scancode = C.SDL_SCANCODE_RESERVED

	SCANCODE_COUNT Scancode = C.SDL_SCANCODE_COUNT
)
